# network_analyzer_enhanced.py
"""
Enhanced Smart Network Device Identifier
- Adds MAC tracking and IP->MAC conflict detection
- Logs TTL values & checks variance per IP
- Saves sample packets (PCAP) for top suspicious IPs
- Allows selecting capture interface (auto-detect fallback)
- Ignores broadcast/multicast noise by default
- Basic SYN flood / suspicious handshake detection
"""
